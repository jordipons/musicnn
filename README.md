# musicnn
Pronounced as "musician", `musicnn` is a set of pre-trained musically motivated convolutional neural networks for music audio tagging. It also includes some pre-trained [vgg-like](https://www.quora.com/What-is-the-VGG-neural-network) baselines.
