...
python -m musicnn.tagger file_name.au --model 'MTT' --top_n 3 --len 3 --ov 3 --print --save out.tags
~~~~~
...
python -m musicnn.tagger file_name.mp3 --model 'MTT' --top_n 10 --len 3 --ov 3 --print --save out.tags
~~~~
