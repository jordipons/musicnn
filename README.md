...
python -m musicnn.tagger file_name.au --model 'MSD_big' --topN 3 --length 3 --overlap 1.5 --print
~~~~~
...
python -m musicnn.tagger file_name.mp3 --model 'MSD' --topN 10 --length 3 --overlap 1 --print --save out.tags
~~~~
