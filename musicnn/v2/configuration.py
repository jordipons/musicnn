...
GENRES_LABELS = ['Electronic', 'Experimental', 'Folk', 'Hip-Hop', 'Instrumental', 'International', 'Pop', 'Rock', 'Blues', 'Classical', 'Country', 'Easy Listening', 'Jazz', 'Old-Time / Historic', 'Soul-RnB', 'Spoken']